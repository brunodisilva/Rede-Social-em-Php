...
$owner_beer = new se_beers();
 ...
 if($task == "beer_back") {  
	...
	$user_beer->beer_back($user->user_info[user_id],$owner->user_info[user_id]);
   ...
   // SEND beer EMAIL
	...
	// INSERT ACTION  
	$actions->actions_add($user, "sendbeer", Array('[beer_owner]', '[beer_sender]'), Array($owner->user_info[user_username], $user->user_info[user_username]));    
