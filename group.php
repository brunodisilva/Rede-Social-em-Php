...
/* $Id: group.php 52 2009-02-05 04:02:46Z john $ */
...
$allowed_to_view = ($privacy_max & $group->group_info['group_privacy']);
...
$allowed_to_discuss = ($privacy_max & $group->group_info['group_discussion']);

// CHECK IF USER IS ALLOWED TO UPLOAD PHOTOS
$allowed_to_upload = ($privacy_max & $group->group_info['group_upload']);

// CHECK IF USER IS ALLOWED TO INVITE MEMBERS
$allowed_to_invite = ( $group->user_rank>=1 || ($group->user_rank>-1 && $group->group_info['group_invite']) );
