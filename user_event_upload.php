...
/* $Id: user_event_upload.php 16 2009-01-13 04:01:31Z john $ */
  ...
  for($f=1;$f<6;$f++)
  {
    ...
    if($_FILES[$fileid]['name'] != "")
    {
      ...
      if( !$file_result[$fileid]['is_error'] )
      {
        ...
        $media_path = $url->url_base.substr($event->event_dir($event->event_info[event_id]), 2).$file_result[$fileid]['eventmedia_id']."_thumb.jpg";
        $local_media_path = substr($event->event_dir($event->event_info[event_id]), 2).$file_result[$fileid]['eventmedia_id']."_thumb.jpg";
        ...
        { 
          ...
          $action_media[] = Array(
            'media_link' => $url->url_base."event_album_file.php?event_id=".$event->event_info[event_id]."&eventmedia_id=".$file_result[$fileid]['eventmedia_id'],
