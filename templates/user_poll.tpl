    ...
    <tr>
      <td class='poll_left' width='100%'>
        ...
        <div class='poll_options'>
          ...
          {* OPEN/CLOSE *}
          <div class="sePollsClose" style='float: left; padding-left: 15px;{if  $polls[poll_loop]->poll_info.poll_closed} display: none;{/if}'><a href='javascript:void(0);' onclick="SupremeEdition.Polls.togglePoll({$polls[poll_loop]->poll_info.poll_id}, true );"><img src='./images/icons/poll_close16.gif' border='0' class='button'>{lang_print id=2500047}</a></div>
          <div class="sePollsOpen"  style='float: left; padding-left: 15px;{if !$polls[poll_loop]->poll_info.poll_closed} display: none;{/if}'><a href='javascript:void(0);' onclick="SupremeEdition.Polls.togglePoll({$polls[poll_loop]->poll_info.poll_id}, false);"><img src='./images/icons/poll_open16.gif' border='0' class='button'>{lang_print id=2500046}</a></div>
            
          {* DELETE *}
          <div class="sePollsDelete" style='float: left; padding-left: 15px;'><a href='javascript:void(0);' onclick="SupremeEdition.Polls.deletePoll({$polls[poll_loop]->poll_info.poll_id});"><img src='./images/icons/poll_delete16.gif' border='0' class='button'>{lang_print id=2500048}</a></div>
          <div style='clear: both; height: 0px;'></div>
        </div>
      </td>
    </tr>
...
<div style='display: none;' id='confirmpolldelete'>
  ...
  <br>
  <input type='button' class='button' value='{lang_print id=175}' onClick='parent.TB_remove();parent.SupremeEdition.Polls.deletePollConfirm(parent.SupremeEdition.Polls.currentConfirmDeleteID);'> <input type='button' class='button' value='{lang_print id=39}' onClick='parent.TB_remove();'>
</div>
