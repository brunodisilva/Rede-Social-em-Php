...
{if $musiclist}
  ...
  <div id="seMusicListContainer">
    ...
    <script type="text/javascript">
      ...
      SupremeEdition.Music = new SupremeEditionAPI.Music();
      SupremeEdition.RegisterModule(SupremeEdition.Music);
      ...
      <li id="seMusic_{$musiclist[music_loop].music_id}" class="seMusicRow">
        <table cellpadding='0' cellspacing='0' class="seMusicRowInnerTable"><tr>
          ...
          <td class='seMusicRowTitle music_title' id="seMusicTitle_{$musiclist[music_loop].music_id}">
            ...
            <span class="seMusicTitleEdit">&nbsp;(<a href="javascript:void(0);" onclick="SupremeEdition.Music.editMusicTitle({$musiclist[music_loop].music_id});">{lang_print id=187}</a>)</span>
            <span class="seMusicTitleSave" style="display:none;">&nbsp;(<a href="javascript:void(0);" onclick="SupremeEdition.Music.saveMusicTitle({$musiclist[music_loop].music_id});">{lang_print id=746}</a>)</span>
            <span class="seMusicTitleCancel" style="display:none;">&nbsp;(<a href="javascript:void(0);" onclick="SupremeEdition.Music.cancelMusicTitle({$musiclist[music_loop].music_id});">{lang_print id=747}</a>)</span>
          </td>
          ...
          <td class="seMusicRowActions" align='right' nowrap='nowrap'>
            {* MUSIC DELETE *}
            <span class="seMusicDelete"><a href="javascript:void(0);" onclick="SupremeEdition.Music.deleteMusic({$musiclist[music_loop].music_id});">{lang_print id=155}</a>&nbsp;</span>
          </td>
    ...
    <div style='display: none;' id='confirmmusicdelete'>
      ...
      <br />
      {lang_block id=175 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.TB_remove();parent.SupremeEdition.Music.deleteMusicConfirm(parent.SupremeEdition.Music.currentConfirmDeleteID);' />{/lang_block}
