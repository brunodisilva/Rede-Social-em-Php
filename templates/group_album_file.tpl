...
{* $Id: group_album_file.tpl 34 2009-01-24 04:17:28Z john $ *}

{* SET GROUP OWNER *}
<script type="text/javascript">
  // User - Owner
  SupremeEdition.Owner = new SupremeEditionAPI.User();
  SupremeEdition.Owner.ImportUserInfo({$se_javascript->generateUserInfo($groupowner)});
  ...
  <td style='text-align: center;'>
    ...
    <div class='album_media_caption' style='width: {if $media_info.groupmedia_width > 300}{$media_info.groupmedia_width}{else}300{/if}px;'>
      ...
      {if $is_image && $allowed_to_tag}
        <a href='javascript:void(0);' onClick="SupremeEdition.GroupMediaTag.addTag();">{lang_print id=2000275}</a>
      {/if}
...
<div style='display: none;' id='sharethis'>
  ...
  SupremeEdition.GroupMediaTag = new SupremeEditionAPI.Tags({ldelim}
...
<div style='margin-left: auto; margin-right: auto;'>
  ...
  <script type="text/javascript">
    ...
    SupremeEdition.GroupMediaComments = new SupremeEditionAPI.Comments({ldelim}
    ...
    SupremeEdition.RegisterModule(SupremeEdition.GroupMediaComments);
       
    // Backwards
    function addComment(is_error, comment_body, comment_date)
    {ldelim}
      SupremeEdition.GroupMediaComments.addComment(is_error, comment_body, comment_date);
    {rdelim}
        
    function getComments(direction)
    {ldelim}
      SupremeEdition.GroupMediaComments.getComments(direction);
    {rdelim}
