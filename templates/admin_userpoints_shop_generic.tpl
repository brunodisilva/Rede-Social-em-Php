...
<h2>{lang_print id=100016230}</h2>
{lang_print id=100016231}

<br><br>
<table class='tabs' cellpadding='0' cellspacing='0'>
<tr>
<td class='tab0'>&nbsp;</td>
<td class='tab1' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_shop.php?task=edit&item_id={$item_id}'>{lang_print id=100016257}{else}{lang_print id=100016257}{/if}</a></td>
<td class='tab'>&nbsp;</td>
<td class='tab2' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_shopphoto.php?item_id={$item_id}'>{lang_print id=100016258}</a>{else}{lang_print id=100016258}{/if}</td>
<td class='tab'>&nbsp;</td>
<td class='tab2' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_shopcomments.php?item_id={$item_id}'>{lang_print id=100016259}</a>{else}{lang_print id=100016259}{/if}</td>
<td class='tab3'>&nbsp;<a href='admin_userpoints_shop.php'>&#171; &nbsp; {lang_print id=100016260}</a></td>
</tr>
</table>
...
<tr>
<td class='form1'>{lang_print id=100016237}</td>
<td class='form2'><input type='text' class='text' name='offer_cost' value='{$offer_cost}' size='40' maxlength='50'></td>
</tr>

<tr>
<td class='form1'>{lang_print id=100016234}</td>
<td class='form2'><textarea style="width:500px" name='redirect_url' rows='8' cols='40' class='text'>{$redirect_url}</textarea></td>
</tr>

<tr>
<td class='form1'>{lang_print id=100016235}</td>
<td class='form2'> 
<select class='text' name='appear_in_transactions'>
<option value='1'{if $appear_in_transactions == 1} SELECTED{/if}>{lang_print id=100016249}</option>
<option value='0'{if $appear_in_transactions == 0} SELECTED{/if}>{lang_print id=100016250}</option>
</select>
</td>
</tr>

<tr>
<td class='form1'>{lang_print id=100016236}</td>
<td class='form2'>

<select class='text' name='offer_transact_state'>
<option value='0'{if $offer_transact_state == 0} SELECTED{/if}>{lang_print id=100016247}</option>
<option value='1'{if $offer_transact_state == 1} SELECTED{/if}>{lang_print id=100016248}</option>
</select>
...
<tr>
<td class='form1'>{lang_print id=100016253}</td>
<td class='form2'>


<input id="offer_levels_input" type="text" readonly="readonly" class="multiSelect" value="{lang_print id=100016255}" style="cursor: default;" />
...
<label class="selectAll"><input type="checkbox" class="selectAll" /> {lang_print id=100016256} </label>
{section name=level_loop loop=$levels}
<label><input type="checkbox" name="offer_levels[]" value="{$levels[level_loop].level_id}" {if $levels[level_loop].level_selected} checked="checked" {/if}/> {$levels[level_loop].level_name} {if $levels[level_loop].level_default} {lang_print id=100016252} {/if} </label>
{/section}
</div>
...
<tr>
<td class='form1'>{lang_print id=100016254}</td>
<td class='form2'>


<input id="offer_subnets_input" type="text" readonly="readonly" class="multiSelect" value="{lang_print id=100016255}" style="cursor: default;" />
...
<tr>
<td class='form1'>{lang_print id=100016240}</td>
<td class='form2'>

<select class='text' name='offer_enabled'>
<option value='1'{if $offer_enabled == 1} SELECTED{/if}>{lang_print id=100016241}</option>
<option value='0'{if $offer_enabled == 0} SELECTED{/if}>{lang_print id=100016242}</option>
</select>
...
<tr>
<td class='form1'>{lang_print id=100016246}</td>
<td class='form2'>

<select class='text' name='offer_allow_comments'>
<option value='1'{if $offer_allow_comments == 1} SELECTED{/if}>{lang_print id=100016249}</option>
<option value='0'{if $offer_allow_comments == 0} SELECTED{/if}>{lang_print id=100016250}</option>
</select>
...
<tr>
<td class='form1'>{lang_print id=100016245}</td>
...
<td class='form2'>
  <table cellpadding='0' cellspacing='0'>
  <tr>
  <td><input type='submit' class='button' value='{lang_print id=100016238}'>&nbsp;</td>
  <input type='hidden' name='task' value='addoffer'>
  <input type='hidden' name='item_id' value='{$item_id}'>
  </form>
  <form action='admin_userpoints_shop.php' method='POST'>
  <td><input type='submit' class='button' value='{lang_print id=100016239}'></td>
  </tr>
  </form>
  </table>
</td>
