...
{* $Id: event.tpl 9 2009-01-11 06:03:21Z john $ *}
...
<!--
  SupremeEdition.Event = new SupremeEditionAPI.Event({$event->event_generate_javascript_structure()}, {ldelim} 'defaultView' : '{$v}', 'ajaxURL' : SupremeEdition.URL.url_base + 'event_ajax.php' {rdelim});
  SupremeEdition.RegisterModule(SupremeEdition.Event);
  
  // Delete redirect function
  function redirectOnDelete()
  {ldelim}
    window.location.href = SupremeEdition.URL.url_base + 'user_event.php';
  {rdelim}
//-->
</script>
...
<div style='display: none;' id='confirmeventrequestcancel'>
  ...
  <br />
  {lang_block id=175 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.SupremeEdition.Event.cancelConfirm();' />{/lang_block}
...
<div style='display: none;' id='confirmeventleave'>
  ...
  <br />
  {lang_block id=3000219 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.SupremeEdition.Event.leaveConfirm();' />{/lang_block}
  {lang_block id=39 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.TB_remove();' />{/lang_block}
</div>
...
<div style='display: none;' id='confirmeventdelete'>
  ...
  <br />
  {lang_block id=175 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.SupremeEdition.Event.deleteConfirm();' />{/lang_block}
  {lang_block id=39 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.TB_remove();' />{/lang_block}
</div>
...
<div style='display: none;' id='eventmemberinvite'>
  ...
  <div style='display:none;text-align:left;padding:10px;' id='inviteForm'>
    ...
    <div><a href='javascript:void(0);' id="eventMemberInviteSelectAll" onClick="var checkboxes = document.getElementsByTagName('input'); for( var i=0, l=checkboxes.length; i<l; i++ ) if( checkboxes[i].type=='checkbox' && parseInt(checkboxes[i].value)>0 ) {ldelim} checkboxes[i].checked = true; parent.SupremeEdition.Event.memberInviteUpdate(checkboxes[i].value, true); {rdelim}">{lang_print id=3000228}</a></div>
    <div id='invite_friendlist' class='invite_friendlist'></div>
    
    <div style='margin-top: 20px;'>
      {lang_block id=3000225 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.SupremeEdition.Event.memberInviteSend();' />{/lang_block}
      {lang_block id=39 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.TB_remove();' />{/lang_block}
    </div>
  </div>
...
{* BEGIN LEFT COLUMN *}
  ...
  <table class='profile_menu' cellpadding='0' cellspacing='0' width='100%'>
    ...
    <tr>
      <td class='profile_menu1'>
        <a href='javascript:void(0);' onclick="SupremeEdition.Event.deleteShow();">
    ...
    *}
    ...
    <tr id="eventProfileMenuJoin"{if !(!$event->is_member && !$event->is_member_waiting && !$event->event_info.event_inviteonly) && !($event->eventmember_info.eventmember_approved && !$event->eventmember_info.eventmember_status)} style="display:none;"{/if}>
      <td class='profile_menu1'>
        <a href='javascript:void(0);' onclick="SupremeEdition.Event.join();">
    ...
    *}
    ...
    <tr id="eventProfileMenuRequest"{if !(!$event->is_member && !$event->is_member_waiting && $event->event_info.event_inviteonly)} style="display:none;"{/if}>
      <td class='profile_menu1'>
        <a href='javascript:void(0);' onclick="SupremeEdition.Event.request();">
          <img src='./images/icons/event_join16.gif' border='0' class='icon' />
    ...
    <tr id="eventProfileMenuCancel"{if !(!$event->eventmember_info.eventmember_approved && $event->eventmember_info.eventmember_status)} style="display:none;"{/if}>
      <td class='profile_menu1'>
        <a href='javascript:void(0);' onclick="SupremeEdition.Event.cancelShow();">
    ...
    <tr id="eventProfileMenuRSVP"{if !$event->is_member} style="display:none;"{/if}>
      <td class='profile_menu1'>
        <a href='javascript:void(0);' onclick="SupremeEdition.Event.rsvpShow();">
    ...
    *}
    ...
    <tr id="eventProfileMenuLeave"{if $event->user_rank==3 || !$event->is_member} style="display:none;"{/if}>
      <td class='profile_menu1'>
        <a href='javascript:void(0);' onclick="SupremeEdition.Event.leaveShow();">
          <img src='./images/icons/event_remove16.gif' border='0' class='icon' />
    ...
    <tr id="eventProfileMenuInvite"{if $event->user_rank!=3 && !($event->is_member && $event->event_info.event_invite)} style="display:none;"{/if}>
      <td class='profile_menu1'>
        <a href='javascript:void(0);' onclick='SupremeEdition.Event.memberInvitePopulate();'>
    ...
    <tr>
      <td class='profile_menu1'>
        <a href="javascript:TB_show('{lang_print id=3000172}', 'user_report.php?return_url={$url->url_current()}&TB_iframe=true&height=300&width=450', '', './images/trans.gif');">
    ...
    <tr>
      <td class='profile'>
        ...
        <table cellpadding='0' cellspacing='0'>
          <tr>
            <td style="vertical-align:middle;padding:3px 3px 0px 0px;"><input class="seEventProfileRSVP" type="radio" id="seEventProfileRSVP_1" name="event_rsvp" onchange="SupremeEdition.Event.rsvpConfirm(1, true);"{if $event->eventmember_info.eventmember_rsvp==1} checked{/if} /></td>
            <td style="vertical-align:middle;padding:3px 3px 0px 0px;"><label for="seEventProfileRSVP_1">{lang_print id=3000082}</label></td>
          </tr>
          <tr>
            <td style="vertical-align:middle;padding:3px 3px 0px 0px;"><input class="seEventProfileRSVP" type="radio" id="seEventProfileRSVP_2" name="event_rsvp" onchange="SupremeEdition.Event.rsvpConfirm(2, true);"{if $event->eventmember_info.eventmember_rsvp==2} checked{/if} /></td>
            <td style="vertical-align:middle;padding:3px 3px 0px 0px;"><label for="seEventProfileRSVP_2">{lang_print id=3000083}</label></td>
          </tr>
          <tr>
            <td style="vertical-align:middle;padding:3px 3px 3px 0px;"><input class="seEventProfileRSVP" type="radio" id="seEventProfileRSVP_3" name="event_rsvp" onchange="SupremeEdition.Event.rsvpConfirm(3, true);"{if $event->eventmember_info.eventmember_rsvp==3} checked{/if} /></td>
          ...
          <table cellpadding='0' cellspacing='0'>
            <tr>
              <td class='event_tab event_tab_left event_tab_active' id='event_tabs_profile' onMouseUp="this.blur();" nowrap="nowrap">
                <a href='javascript:void(0);' onMouseDown="SupremeEdition.Event.loadProfileTab('profile')" onMouseUp="this.blur();">{lang_print id=3000137}</a>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table cellpadding='0' cellspacing='0'>
            <tr>
              <td class='event_tab' id='event_tabs_calendar' onMouseUp="this.blur();" nowrap="nowrap">
                <a href='javascript:void(0);' onMouseDown="SupremeEdition.Event.loadProfileTab('calendar');" onMouseUp="this.blur();">{lang_print id=3000244}</a>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table cellpadding='0' cellspacing='0'>
            <tr>
              <td class='event_tab' id='event_tabs_members' onMouseUp="this.blur();" nowrap="nowrap">
                <a href='javascript:void(0);' onMouseDown="SupremeEdition.Event.loadProfileTab('members');" onMouseUp="this.blur();">{lang_print id=3000138}</a>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table cellpadding='0' cellspacing='0'>
            <tr>
              <td class='event_tab' id='event_tabs_photos' onMouseUp="this.blur();" nowrap="nowrap">
                <a href='javascript:void(0);' onMouseDown="SupremeEdition.Event.loadProfileTab('photos');" onMouseUp="this.blur();">{lang_print id=3000164}</a>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table cellpadding='0' cellspacing='0'>
            <tr>
              <td class='event_tab' id='event_tabs_comments' onMouseUp="this.blur();" nowrap="nowrap">
                <a href='javascript:void(0);' onMouseDown="SupremeEdition.Event.loadProfileTab('comments');SupremeEdition.EventComments.getComments(1);" onMouseUp="this.blur();">{lang_print id=854}</a>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table cellpadding='0' cellspacing='0'>
            <tr>
              <td class='event_tab' id='event_tabs_{$plugin_k}' onMouseUp="this.blur();" nowrap="nowrap">
                <a href='javascript:void(0);' onMouseDown="SupremeEdition.Event.loadProfileTab('{$plugin_k}');" onMouseUp="this.blur();">{lang_print id=$plugin_v.menu_profile_tab.title}</a>
              </td>
            </tr>
          </table>
        </td>
      ...
      *}
      ...
      <div id='event_members' style='display: none;'>
       ...
       <!-- 
        ...
        <tr>
        <td valign='top'>
          <div class='event_headline'>{lang_print id=3000160} ({$total_members})</div>
        </td>
      ...
      <div id='event_photos' style='display: none;'>
         ...
         <div class='event_headline' style='float: left;'>{lang_print id=3000164} (<span id='event_{$event->event_info.event_id}_totalfiles'>{$eventalbum_info.eventalbum_totalfiles|default:0}</span>)</div>
          {if $allowed_to_upload}
            <div style='float: right; padding-left: 10px;'>
              <a href="javascript:TB_show(SupremeEdition.Language.Translate(3000165), 'user_event_upload.php?event_id={$event->event_info.event_id}&TB_iframe=true&height=300&width=500', '', './images/trans.gif');">
        ...
        <script type="text/javascript">
          ...
          SupremeEdition.EventFiles = new SupremeEditionAPI.EventFiles({ldelim}
            'paginate' : true,
            'cpp' : 18,
            ...
            'ajaxURL' : SupremeEdition.URL.url_base + 'event_ajax.php'
          {rdelim});
          
          SupremeEdition.RegisterModule(SupremeEdition.EventFiles);
      ...
      <div id='event_comments' style='display: none;'>
        ...
        <script type="text/javascript">
          ...
          SupremeEdition.EventComments = new SupremeEditionAPI.Comments({ldelim}
            ...
            'ajaxURL' : SupremeEdition.URL.url_base + 'misc_js.php'
            
          {rdelim});
          
          SupremeEdition.RegisterModule(SupremeEdition.EventComments);
          
          // Backwards
          function addComment(is_error, comment_body, comment_date)
          {ldelim}
            SupremeEdition.EventComments.addComment(is_error, comment_body, comment_date);
          {rdelim}
          
          function getComments(direction)
          {ldelim}
            SupremeEdition.EventComments.getComments(direction);
          {rdelim}
