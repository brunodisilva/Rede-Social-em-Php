...
{* $Id: admin_job.tpl 7 2009-01-11 06:01:49Z john $ *}

<h2>{lang_print id=6400077}</h2>
{lang_print id=6400078}
<br />
<br />
...
<form action='admin_job.php' method='post'>
...
<table cellpadding='0' cellspacing='0' width='600'>
  ...
  <tr>
    <td class='setting1'>{lang_print id=6400079}</td>
  </tr>
  <tr>
    <td class='setting2'>
      <table cellpadding='2' cellspacing='0'>
        <tr>
          <td><input type='radio' name='setting_permission_job' id='setting_permission_job_1' value='1'{if  $setting.setting_permission_job} checked{/if} /></td>
          <td><label for='setting_permission_job_1'>{lang_print id=6400080}</label></td>
        </tr>
        <tr>
          <td><input type='radio' name='setting_permission_job' id='setting_permission_job_0' value='0'{if !$setting.setting_permission_job} checked{/if} /></td>
          <td><label for='setting_permission_job_0'>{lang_print id=6400081}</label></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table cellpadding='0' cellspacing='0' width='600'>
  <tr>
    <td class='header'>{lang_print id=6400082}</td>
  </tr>
  <tr>
    <td class='setting1'>{lang_print id=6400083}</td>
  </tr>
  <tr>
    <td class='setting2'>
      ...
      <div style='font-weight: bold;'>
        &nbsp;
        {lang_print id=6400084} - <a href='javascript:addcat();'>[{lang_print id=104}]</a>
      </div>
      ...
      <div id='categories' style='padding-left: 5px; font-size: 8pt;'>
        ...
        <div id='cat_{$cats[cat_loop].cat_id}'>
          ...
          <div style='padding-left: 20px; padding-top: 5px; padding-bottom: 3px;'>
            {lang_print id=100} - 
            <a href='admin_fields.php?type=job&task=addfield&cat_id={$cats[cat_loop].cat_id}&hideSearch=0&hideDisplay=1&hideSpecial=1&TB_iframe=true&height=640&width=640' class='smoothbox' title='{lang_print id=101}'>[{lang_print id=101}]</a>
          </div>
          ...
          <div id='fields_{$cats[cat_loop].cat_id}' style='padding-left: 20px;'>
            ...
            <div id='field_{$cats[cat_loop].fields[field_loop].field_id}' style='padding-left: 15px; padding-bottom: 3px;'>
              <div>
                ...
                <a href='admin_fields.php?type=job&task=getfield&field_id={$cats[cat_loop].fields[field_loop].field_id}&hideSearch=0&hideDisplay=1&hideSpecial=1&TB_iframe=true&height=640&width=640' class='smoothbox' title='{lang_print id=140}'>{lang_print id=$cats[cat_loop].fields[field_loop].field_title}</a>
              </div>
              ...
              <div id='dep_fields_{$cats[cat_loop].fields[field_loop].field_id}' style='margin-left: 15px;'>
                ...
                <div id='dep_field_{$cats[cat_loop].fields[field_loop].field_options[dep_field_loop].dep_field_id}' style='padding-top: 3px;'>
                  <div>
                    ...
                    <a href='admin_fields.php?type=job&task=getdepfield&field_id={$cats[cat_loop].fields[field_loop].field_options[dep_field_loop].dep_field_id}&hideSearch=0&hideDisplay=1&hideSpecial=1&TB_iframe=true&height=640&width=640' class='smoothbox' title='{lang_print id=148}' id='dep_field_title_{$cats[cat_loop].fields[field_loop].field_options[dep_field_loop].dep_field_id}'><i>{lang_print id=102}</i></a>
                  </div>
                </div>
                {/if}
                {/section}
