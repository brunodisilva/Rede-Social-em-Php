...
{else}
  ...
  <script type="text/javascript">
    ...
    SupremeEdition.Music.options.ajaxURL = 'admin_viewmusic.php';
  ...
  <table cellpadding='0' cellspacing='0' class='list'>
    ...
    <tr class='{cycle values="background1,background2"} seMusicRow' id="seMusic_{$entries[music_loop].music_id}">
      ...
      <td class='item'>
        [ <a href="javascript:void(0);" onclick="SupremeEdition.Music.deleteMusic({$entries[music_loop].music_id});">{lang_print id=155}</a> ]
  ...
  <div style='display: none;' id='confirmmusicdelete'>
    ...
    <br>
    <input type='button' class='button' value='{lang_print id=175}' onClick='parent.TB_remove();parent.SupremeEdition.Music.deleteMusicConfirm(parent.SupremeEdition.Music.currentConfirmDeleteID);'> <input type='button' class='button' value='{lang_print id=39}' onClick='parent.TB_remove();'>
  </div>
