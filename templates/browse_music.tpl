...
{* $Id: browse_music.tpl 11 2009-01-11 06:03:58Z john $ *}
...
<embed src="./swf/playlistplayer.swf"
width="200" height="110" allowscriptaccess="always" allowfullscreen="false"
flashvars="height=110&width=200&file={$media_path}&screencolor=0xFFFFFF&logo=./swf/logomusic.png&showstop=true&usefullscreen=false&showdownload=false&autostart=false"/>
