...
<h2>{lang_print id=100016369}</h2>
{lang_print id=100016370}

<br><br>
<table class='tabs' cellpadding='0' cellspacing='0'>
<tr>
<td class='tab0'>&nbsp;</td>
<td class='tab1' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_offers.php?task=edit&item_id={$item_id}'>{lang_print id=100016398}{else}{lang_print id=100016398}{/if}</a></td>
<td class='tab'>&nbsp;</td>
<td class='tab2' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_offerphoto.php?item_id={$item_id}'>{lang_print id=100016399}</a>{else}{lang_print id=100016399}{/if}</td>
<td class='tab'>&nbsp;</td>
<td class='tab2' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_offercomments.php?item_id={$item_id}'>{lang_print id=100016400}</a>{else}{lang_print id=100016400}{/if}</td>
<td class='tab3'>&nbsp;<a href='admin_userpoints_offers.php'>&#171; &nbsp; {lang_print id=100016401}</a></td>
</tr>
</table>
...
<tr>
<td class='form1'>{lang_print id=100016375}</td>
<td class='form2'><input type='text' class='text' name='offer_cost' value='{$offer_cost}' size='20'></td>
</tr>

<tr>
<td class='form1'>{lang_print id=100016373}</td>
<td class='form2'><input type='text' class='text' name='poll_id' value='{$poll_id}' size='20'></td>
</tr>

<tr>
<td class='form1'>{lang_print id=100016385}</td>
<td class='form2'>

<select class='text' name='offer_transact_state'>
<option value='0'{if $offer_transact_state == 0} SELECTED{/if}>{lang_print id=100016386}</option>
<option value='1'{if $offer_transact_state == 1} SELECTED{/if}>{lang_print id=100016387}</option>
</select>
...
<tr>
<td class='form1'>{lang_print id=100016393}</td>
<td class='form2'>


<input id="offer_levels_input" type="text" readonly="readonly" class="multiSelect" value="{lang_print id=100016395}" style="cursor: default;" />
...
<label class="selectAll"><input type="checkbox" class="selectAll" /> {lang_print id=100016396} </label>
{section name=level_loop loop=$levels}
<label><input type="checkbox" name="offer_levels[]" value="{$levels[level_loop].level_id}" {if $levels[level_loop].level_selected} checked="checked" {/if}/> {$levels[level_loop].level_name} {if $levels[level_loop].level_default} {lang_print id=100016392} {/if} </label>
{/section}
</div>
...
<tr>
<td class='form1'>{lang_print id=100016394}</td>
<td class='form2'>


<input id="offer_subnets_input" type="text" readonly="readonly" class="multiSelect" value="{lang_print id=100016395}" style="cursor: default;" />
...
<tr>
<td class='form1'>{lang_print id=100016378}</td>
<td class='form2'>

<select class='text' name='offer_enabled'>
<option value='1'{if $offer_enabled == 1} SELECTED{/if}>{lang_print id=100016379}</option>
<option value='0'{if $offer_enabled == 0} SELECTED{/if}>{lang_print id=100016380}</option>
</select>
...
<tr>
<td class='form1'>{lang_print id=100016384}</td>
<td class='form2'>

<select class='text' name='offer_allow_comments'>
<option value='1'{if $offer_allow_comments == 1} SELECTED{/if}>{lang_print id=100016389}</option>
<option value='0'{if $offer_allow_comments == 0} SELECTED{/if}>{lang_print id=100016390}</option>
</select>
...
<tr>
<td class='form1'>{lang_print id=100016383}</td>
...
<td class='form2'>
  <table cellpadding='0' cellspacing='0'>
  <tr>
  <td><input type='submit' class='button' value='{lang_print id=100016376}'>&nbsp;</td>
  <input type='hidden' name='task' value='addoffer'>
  <input type='hidden' name='item_id' value='{$item_id}'>
  </form>
  <form action='admin_userpoints_offers.php' method='POST'>
  <td><input type='submit' class='button' value='{lang_print id=100016377}'></td>
  </tr>
  </form>
  </table>
</td>
