	{assign var='statuses_user_timeline' value=$SEP_TwitterUser->statuses_user_timeline(null, null, null, null, null, $statuses_user_timeline_page)}

	{if $statuses_user_timeline->status}
		<div id="statuses_user_timeline_page_{$statuses_user_timeline_page}">
			
			<table border="0" class="SEP_Twitter_Table" cellpadding="0" cellspacing="0" width="100%">
			{foreach from=$statuses_user_timeline->status item=elm}
				<tr id="statuses_user_timeline_{$elm->id}">
		...
		<div id="statuses_user_timeline_page_{$statuses_user_timeline_page+1}">
			<center>
			<br>[<b><a href="javascript:void(0)" onClick="SEP_Twitter_NextPage('statuses_user_timeline_page', {$statuses_user_timeline_page+1}, 'statuses_user_timeline', '{$instance_name}'); this.blur();">{lang_print id=18910022}</a></b>]
			<br><br>
			<div id="statuses_user_timeline_page_{$statuses_user_timeline_page+1}_spinner" style="display:none">
