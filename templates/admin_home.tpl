...
<td class='stat0'>
  ...
  {if $version_num < $versions.license}
    <td style='padding-left: 20px;'><a href='http://www.sCRiPTz-TEAM.iNFO/login.php' target='_blank'><img src='../images/icons/admin_upgrade16.gif' border='0' class='icon2'>{lang_print id=60}</a><br></td>
  {/if}
  </tr>
  </table>
</td>
