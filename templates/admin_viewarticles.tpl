...
{else}
  ...
  {foreach from=$articleentries item=articleentry}
    ...
    <td class='item' nowrap='nowrap'>[ <a href='admin_loginasuser.php?user_id={$articleentry.article_author->user_info.user_id}&return_url={$url->url_encode("`$url->url_base`user_article_edit.php?article_id=`$articleentry.article->article_info.article_id`")}' target='_blank'>edit</a> ]
