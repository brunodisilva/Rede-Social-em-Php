...
<h2>{lang_print id=11140209} {$level_name}</h2>
{lang_print id=11140210}
...
<td valign='top' class='pagecell' rowspan='{math equation='x+5' x=$level_menu|@count}'>
  ...
  <h2>{lang_print id=11140201}</h2>
  {lang_print id=11140202}

  <br><br>

  {if $result != 0}
    <div class='success'><img src='../images/success.gif' class='icon' border='0'> {lang_print id=11140208}</div>
  {/if}
  ...
  <form action='admin_levels_recommendedsettings.php' method='POST'>
  <table cellpadding='0' cellspacing='0' width='600'>
  <tr><td class='header'>{lang_print id=11140203}</td></tr>
  <tr><td class='setting1'>
  {lang_print id=11140204}
  </td></tr><tr><td class='setting2'>
    <table cellpadding='0' cellspacing='0'>
    <tr><td><input type='radio' name='level_recommended_allow' id='recommended_allow_1' value='1'{if $recommended_allow == 1} CHECKED{/if}>&nbsp;</td><td><label for='recommended_allow_1'>{lang_print id=11140205}</label></td></tr>
    <tr><td><input type='radio' name='level_recommended_allow' id='recommended_allow_0' value='0'{if $recommended_allow == 0} CHECKED{/if}>&nbsp;</td><td><label for='recommended_allow_0'>{lang_print id=11140206}</label></td></tr>
    </table>
  </td></tr></table>

  <br>
  
  <input type='submit' class='button' value='{lang_print id=11140207}'>
