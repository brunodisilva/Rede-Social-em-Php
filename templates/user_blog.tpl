...
{if $user->level_info.level_blog_create}
  ...
  {else}
          ...
          <table cellpadding='0' cellspacing='0' width='100%'>
            <tr>
              ...
              <td style='vertical-align: top; text-align: right; padding-left: 10px;'>
                ...
                | 
                <a href='javascript:void(0);' onclick='SupremeEdition.Blog.deleteBlog({$blogentries[blogentry_loop].blogentry_id});'>{lang_print id=155}</a>
              </td>
            </tr>
          </table>
        </div>
    ...
    <div style='display: none;' id='confirmblogdelete'>
      ...
      <br />
      {lang_block id=175 var=langBlockTemp}<input type='button' class='button' value='{$langBlockTemp}' onClick='parent.TB_remove();parent.SupremeEdition.Blog.deleteBlogConfirm();' />{/lang_block}
