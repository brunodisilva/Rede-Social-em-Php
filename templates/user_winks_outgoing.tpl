...
<td class='tab'>&nbsp;</td>
<td class='tab1' NOWRAP><a href='user_winks_outgoing.php'>{lang_print id=14000061}</a></td>
<td class='tab'>&nbsp;</td>
...
<div class='page_header'>{lang_print id=14000076}</div>
<div>{lang_print id=14000077}</div>
...
{if $total_winks == 0}
  ...
  <tr><td class='result'><img src='./images/icons/bulb16.gif' border='0' class='icon'>{lang_print id=14000078}</td></tr>
  </table>
...
{else}
  ...
  {if $maxpage > 1}
    <br>
    <div class='center'>
    {if $p != 1}<a href='user_winks_outgoing.php?p={math equation='p-1' p=$p}'>&#171; {lang_print id=14000066}</a>{else}<font class='disabled'>&#171; {lang_print id=14000066}</font>{/if}
    {if $p_start == $p_end}
      &nbsp;|&nbsp; {lang_print id=14000067} {$p_start} {lang_print id=14000068} {$total_friends} &nbsp;|&nbsp; 
    {else}
      &nbsp;|&nbsp; {lang_print id=14000069} {$p_start}-{$p_end} {lang_print id=14000068} {$total_friends} &nbsp;|&nbsp; 
    {/if}
    {if $p != $maxpage}<a href='user_winks_outgoing.php?p={math equation='p+1' p=$p}'>{lang_print id=14000070} &#187;</a>{else}<font class='disabled'>{lang_print id=14000070} &#187;</font>{/if}
    </div>
  {/if}
  ...
  {* LOOP THROUGH WINKS *}
    ...
    <td class='friends_result2' NOWRAP>
      <a href='user_winks_confirm_outgoing.php?user={$winks[wink_loop].wink_user->user_info.user_username}&task=remove'>{lang_print id=14000079}</a><br>
          </td>
    </tr>
    </table>
    </div>
  ...
  {if $maxpage > 1}
    <br>
    <div class='center'>
    {if $p != 1}<a href='user_winks_outgoing.php?p={math equation='p-1' p=$p}'>&#171; {lang_print id=14000070}</a>{else}<font class='disabled'>&#171; {lang_print id=14000070}</font>{/if}
    {if $p_start == $p_end}
      &nbsp;|&nbsp; {lang_print id=14000067} {$p_start} {lang_print id=14000068} {$total_friends} &nbsp;|&nbsp; 
    {else}
      &nbsp;|&nbsp; {lang_print id=14000069} {$p_start}-{$p_end} {lang_print id=14000068} {$total_friends} &nbsp;|&nbsp; 
