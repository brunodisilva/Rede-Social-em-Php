...
<h2>{lang_print id=11080309} {$level_name}</h2>
{lang_print id=11080310}
...
<td valign='top' class='pagecell' rowspan='{math equation='x+5' x=$level_menu|@count}'>
  ...
  <h2>{lang_print id=11080301}</h2>
  {lang_print id=11080302}

  <br><br>

  {if $result != 0}
    <div class='success'><img src='../images/success.gif' class='icon' border='0'> {lang_print id=11080308}</div>
  {/if}
  ...
  <form action='admin_levels_gmapsettings.php' method='POST'>
  <table cellpadding='0' cellspacing='0' width='600'>
  <tr><td class='header'>{lang_print id=11080303}</td></tr>
  <tr><td class='setting1'>
  {lang_print id=11080304}
  </td></tr><tr><td class='setting2'>
    <table cellpadding='0' cellspacing='0'>
    <tr><td><input type='radio' name='level_gmap_allow' id='gmap_allow_1' value='1'{if $gmap_allow == 1} CHECKED{/if}>&nbsp;</td><td><label for='gmap_allow_1'>{lang_print id=11080305}</label></td></tr>
    <tr><td><input type='radio' name='level_gmap_allow' id='gmap_allow_0' value='0'{if $gmap_allow == 0} CHECKED{/if}>&nbsp;</td><td><label for='gmap_allow_0'>{lang_print id=11080306}</label></td></tr>
    </table>
  </td></tr></table>

  <br>
  
  <input type='submit' class='button' value='{lang_print id=11080307}'>
