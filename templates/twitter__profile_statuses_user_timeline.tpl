	{* User Timeline for Profile Visitor *}
	{assign var='profile_statuses_user_timeline' value=$SEP_TwitterOwner->statuses_user_timeline($SEP_TwitterOwner->screen_name, null, null, null, null, $profile_statuses_user_timeline_page, false)}
