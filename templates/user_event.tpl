...
<script type="text/javascript">
  ...
  SupremeEdition.Event = new SupremeEditionAPI.Event();
...
<div style='display: none;' id='confirmeventrsvp'>
  ...
  <div>
    <a href="javascript:void(0);" onclick="parent.SupremeEdition.Event.rsvpConfirm(1);">{lang_print id=3000099}</a><br />
    <a href="javascript:void(0);" onclick="parent.SupremeEdition.Event.rsvpConfirm(2);">{lang_print id=3000100}</a><br />
    <a href="javascript:void(0);" onclick="parent.SupremeEdition.Event.rsvpConfirm(3);">{lang_print id=3000101}</a><br />
  </div>
</div>
        ...
        <td class='seEventRight' width='100%'>
          ...
          <div class='seEventStats'>
            ...
            <span class="seEventStatusAccept"{if $events[event_loop].event->is_member} style="display:none;"{/if}>
              <a href='javascript:void(0);' onclick="SupremeEdition.Event.removeShow({$events[event_loop].event->event_info.event_id});">
            ...
            <span class="seEventStatusRSVP"{if !$events[event_loop].event->is_member} style="display:none;"{/if}>
              <a href='javascript:void(0);' onclick="SupremeEdition.Event.rsvpShow({$events[event_loop].event->event_info.event_id});" id="seEventRSVP_{$events[event_loop].event->event_info.event_id}">
                {lang_print id=$events[event_loop].event_rsvp_lvid}
              </a>
            </span>
          </div>
          ...
          <div class='seEventOptions'>
            ...
            <div class="seEventOption1 seEventUserOptionJoin"{if !$events[event_loop].event->is_member_waiting || !$events[event_loop].event_approved} style="display:none;"{/if}>
              <a href='javascript:void(0);' onclick="SupremeEdition.Event.join({$events[event_loop].event->event_info.event_id});">
            ...
            <div class="seEventOption1 seEventUserOptionRequestCancel"{if !$events[event_loop].event->is_member_waiting || $events[event_loop].event_approved} style="display:none;"{/if}>
              <a href='javascript:void(0);' onclick="SupremeEdition.Event.cancelShow({$events[event_loop].event->event_info.event_id});">
            ...
            <div class="seEventOption1 seEventUserOptionRsvp"{if !$events[event_loop].event->is_member} style="display:none;"{/if}>
              <a href='javascript:void(0);' onclick="SupremeEdition.Event.rsvpShow({$events[event_loop].event->event_info.event_id});">
            ...
            <div class="seEventOption1 seEventUserOptionLeave"{if $events[event_loop].event->user_rank==3 || !$events[event_loop].event->is_member} style="display:none;"{/if}>
              <a href='javascript:void(0);' onclick="SupremeEdition.Event.leaveShow({$events[event_loop].event->event_info.event_id});">
                <img src='./images/icons/event_remove16.gif' border='0' class='button' />
            ...
            <div class="seEventOption1 seEventUserOptionDelete"{if $events[event_loop].event->user_rank!=3} style="display:none;"{/if}>
              <a href='javascript:void(0);' onclick="SupremeEdition.Event.deleteShow({$events[event_loop].event->event_info.event_id});">
