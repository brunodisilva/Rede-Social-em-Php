  ...
  <td style='text-align: center;'>
    ...
    <div class='album_media_caption' style='width: {if $media_info.media_width > 300}{$media_info.media_width}{else}300{/if}px;'>
      ...
      {if $is_image && $allowed_to_tag}
        <a href='javascript:void(0);' onClick="SupremeEdition.MediaTag.addTag();">{lang_print id=1000163}</a>
      {/if}
...
<script type="text/javascript">
  ...
  SupremeEdition.MediaTag = new SupremeEditionAPI.Tags({ldelim}
    ...
    SupremeEdition.RegisterModule(SupremeEdition.MediaTag);
    ...
    {ldelim}
      SupremeEdition.MediaTag.insertTag(tag_id, tag_link, tag_text, tag_x, tag_y, tag_width, tag_height, tagged_user);
    {rdelim}
...
<div style='margin-left: auto; margin-right: auto;'>
  ...
  <script type="text/javascript">
    ...
    SupremeEdition.MediaComments = new SupremeEditionAPI.Comments({ldelim}
    ...
    SupremeEdition.RegisterModule(SupremeEdition.MediaComments);
       
    // Backwards
    function addComment(is_error, comment_body, comment_date)
    {ldelim}
      SupremeEdition.MediaComments.addComment(is_error, comment_body, comment_date);
    {rdelim}
        
    function getComments(direction)
    {ldelim}
      SupremeEdition.MediaComments.getComments(direction);
    {rdelim}
