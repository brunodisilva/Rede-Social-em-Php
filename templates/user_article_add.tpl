...
<table cellpadding='0' cellspacing='0'>
 ...
 <tr>
  <td class='form1' width='120'>{lang_print id=11151335}</td>
  <td class='form2'>
...
{if $user->level_info.level_article_search == 1}
  <tr>
  <td class='form1' width='120'>{lang_print id=11151318}</td>
  <td class='form2'>
    <table cellpadding='0' cellspacing='0'>
...
{if $privacy_options|@count > 1}
  <tr>
  <td class='form1' width='120'>{lang_print id=11151321}</td>
  <td class='form2'>
    <table cellpadding='0' cellspacing='0'>
...
{if $comment_options|@count > 1}
  <tr>
  <td class='form1' width='120'>{lang_print id=11151323}</td>
  <td class='form2'>
    <table cellpadding='0' cellspacing='0'>
