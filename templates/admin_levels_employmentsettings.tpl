...
<h2>{lang_print id=11050309} {$level_name}</h2>
{lang_print id=11050310}
...
<td valign='top' class='pagecell' rowspan='{math equation='x+5' x=$level_menu|@count}'>
  ...
  <h2>{lang_print id=11050301}</h2>
  {lang_print id=11050302}

  <br><br>

  {if $result != 0}
    <div class='success'><img src='../images/success.gif' class='icon' border='0'> {lang_print id=11050308}</div>
  {/if}
  ...
  <tr><td class='header'>{lang_print id=11050303}</td></tr>
  <tr><td class='setting1'>
  {lang_print id=11050304}
  </td></tr><tr><td class='setting2'>
    <table cellpadding='0' cellspacing='0'>
    <tr><td><input type='radio' name='level_employment_allow' id='employment_allow_1' value='1'{if $employment_allow == 1} CHECKED{/if}>&nbsp;</td><td><label for='employment_allow_1'>{lang_print id=11050305}</label></td></tr>
    <tr><td><input type='radio' name='level_employment_allow' id='employment_allow_0' value='0'{if $employment_allow == 0} CHECKED{/if}>&nbsp;</td><td><label for='employment_allow_0'>{lang_print id=11050306}</label></td></tr>
    </table>
  </td></tr></table>

  <br>
  
  <input type='submit' class='button' value='{lang_print id=11050307}'>
