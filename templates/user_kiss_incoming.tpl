...
<tr>
<td class='tab0'>&nbsp;</td>
<td class='tab1' NOWRAP><a href='user_kiss_incoming.php'>{lang_print id=90000060}</a></td>
<td class='tab'>&nbsp;</td>
...
<div class='page_header'>{lang_print id=90000064}</div>
<div>{lang_print id=90000065}</div>
...
{if $total_kiss == 0}
  ...
  <tr><td class='result'><img src='./images/icons/bulb16.gif' border='0' class='icon'>{lang_print id=90000065}</td></tr>
  </table>
...
{else}
  ...
  {if $maxpage > 1}
    <br>
    <div class='center'>
    {if $p != 1}<a href='user_kiss_incoming.php?p={math equation='p-1' p=$p}'>&#171; {lang_print id=90000066}</a>{else}<font class='disabled'>&#171; {lang_print id=90000066}</font>{/if}
    {if $p_start == $p_end}
      &nbsp;|&nbsp; {lang_print id=90000067} {$p_start} {lang_print id=90000068} {$total_kiss} &nbsp;|&nbsp; 
    {else}
      &nbsp;|&nbsp; {lang_print id=90000069} {$p_start}-{$p_end} {lang_print id=90000068} {$total_kiss} &nbsp;|&nbsp; 
    {/if}
    {if $p != $maxpage}<a href='user_kiss_incoming.php?p={math equation='p+1' p=$p}'>{lang_print id=90000070} &#187;</a>{else}<font class='disabled'>{lang_print id=90000070}&#187;</font>{/if}
    </div>
  {/if}
  ...
  {* LOOP THROUGH kiss *}
    ...
    <a href='user_kiss_confirm_incoming.php?user={$kiss[kiss_loop].kiss_user->user_info.user_username}&task=kiss_back'>{lang_print id=90000073}</a><br>
	<a href='user_kiss_confirm_incoming.php?user={$kiss[kiss_loop].kiss_user->user_info.user_username}&task=remove'>{lang_print id=90000074}</a><br>
