...
<td class='header'>Public Permission Defaults</td>
</tr>
<td class='setting1'>
...
<td class='setting2'>
  ...
  <td><label for='permission_article_1'>Yes, the public can view articles unless they are made private.</label></td>
  </tr>
  <tr>
  ...
  <td><label for='permission_article_0'>No, the public cannot view articles.</label></td>
  </tr>
  </table>
</td>
</tr>
...
<table cellpadding='0' cellspacing='0' width='600'>
<tr><td class='header'>Article Categories</td></tr>
<td class='setting1'>
  You may want to allow your users to categorize their articles by subject, location, etc. Categorized articles make it easier for users to find and attend articles that interest them. If you want to allow article categories, you can create them (along with subcategories) below.
</td></tr>
<tr>
<td class='setting2'>
  <table cellpadding='0' cellspacing='0'>
  <tr><td><b>Article Categories</b></td></tr>
  {foreach from=$categories item=category}
    ...
    {/foreach}
    <p id='newsubcategory{$category.articlecat_id}' style='margin: 0px;'></p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:addInput2('newsubcategory', '{$category.articlecat_id}')">Add Subcategory</a></p>
    </td></tr>
  ...
  <a href="javascript:addInput('newcategory')">Add category</a><input type='hidden' name='num_articlecategories' value='{$cat_max_id}'></td></tr>
</td>
</tr>
</table>
