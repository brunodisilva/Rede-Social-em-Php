...
<td class='tab'>&nbsp;</td>
<td class='tab1' NOWRAP><a href='user_beers_outgoing.php'>{lang_print id=16000061}</a></td>
<td class='tab'>&nbsp;</td>
...
<div class='page_header'>{lang_print id=16000076}</div>
<div>{lang_print id=16000077}</div>
...
{if $total_beers == 0}
  ...
  <tr><td class='result'><img src='./images/icons/bulb16.gif' border='0' class='icon'>{lang_print id=16000078}</td></tr>
  </table>
...
{else}
  ...
  {if $maxpage > 1}
    <br>
    <div class='center'>
    {if $p != 1}<a href='user_beers_outgoing.php?p={math equation='p-1' p=$p}'>&#171; {lang_print id=16000066}</a>{else}<font class='disabled'>&#171; {lang_print id=16000066}</font>{/if}
    {if $p_start == $p_end}
      &nbsp;|&nbsp; {lang_print id=16000067} {$p_start} {lang_print id=16000068} {$total_friends} &nbsp;|&nbsp; 
    {else}
      &nbsp;|&nbsp; {lang_print id=16000069} {$p_start}-{$p_end} {lang_print id=16000068} {$total_friends} &nbsp;|&nbsp; 
    {/if}
    {if $p != $maxpage}<a href='user_beers_outgoing.php?p={math equation='p+1' p=$p}'>{lang_print id=16000070} &#187;</a>{else}<font class='disabled'>{lang_print id=16000070} &#187;</font>{/if}
    </div>
  {/if}
  ...
  {* LOOP THROUGH beerS *}
    ...
    <td class='friends_result2' NOWRAP>
      <a href='user_beers_confirm_outgoing.php?user={$beers[beer_loop].beer_user->user_info.user_username}&task=remove'>{lang_print id=16000079}</a><br>
          </td>
    </tr>
    </table>
    </div>
  ...
  {if $maxpage > 1}
    <br>
    <div class='center'>
    {if $p != 1}<a href='user_beers_outgoing.php?p={math equation='p-1' p=$p}'>&#171; {lang_print id=16000070}</a>{else}<font class='disabled'>&#171; {lang_print id=16000070}</font>{/if}
    {if $p_start == $p_end}
      &nbsp;|&nbsp; {lang_print id=16000067} {$p_start} {lang_print id=16000068} {$total_friends} &nbsp;|&nbsp; 
    {else}
      &nbsp;|&nbsp; {lang_print id=16000069} {$p_start}-{$p_end} {lang_print id=16000068} {$total_friends} &nbsp;|&nbsp; 
