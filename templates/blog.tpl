...
{* $Id: blog.tpl 53 2009-02-06 04:55:08Z john $ *}
...
<script type="text/javascript">
  ...
  SupremeEdition.Blog = new SupremeEditionAPI.Blog();
  SupremeEdition.RegisterModule(SupremeEdition.Blog);
  ...
  {if $blogentry_id && $total_blogentries==1}
    ...
    <div class='seBlogComments'>
      ...
      <table cellpadding='0' cellspacing='0' border="0" width="100%"><tr><td valign="top">
        ...
        <div style='margin-bottom: 20px;'>
          ...
          <div class='button' style='float: left; padding-left: 20px;'>
            <a href="javascript:TB_show(SupremeEdition.Language.Translate(861), 'user_report.php?return_url={$url->url_current()}&TB_iframe=true&height=300&width=450', '', './images/trans.gif');"><img src='./images/icons/report16.gif' border='0' class='button'>{lang_print id=861}</a>
          </div>
      ...
      <script type="text/javascript">
        ...
        SupremeEdition.BlogComments = new SupremeEditionAPI.Comments({ldelim}
        ...
        SupremeEdition.RegisterModule(SupremeEdition.BlogComments);
        
        // Backwards
        function addComment(is_error, comment_body, comment_date)
        {ldelim}
          SupremeEdition.BlogComments.addComment(is_error, comment_body, comment_date);
        {rdelim}
        
        function getComments(direction)
        {ldelim}
          SupremeEdition.BlogComments.getComments(direction);
        {rdelim}
        ...
        <li style="margin-top: 10px; margin-bottom: 20px;">
          <div style="overflow: hidden;">
            ...
            <div class="profile_comment_links">
              ...
              &nbsp;|&nbsp;
              <a class="commentReportLink" href="javascript:void(0);" onclick="javascript:TB_show(SupremeEdition.Language.Translate(861), 'user_report.php?return_url={$url->url_current()}&TB_iframe=true&height=300&width=450', '', './images/trans.gif');">
    ...
    <div>
      ...
      <div style='margin: 10px 0px 10px 0px;'>
        ...
        {if $user->user_exists && $user->user_info.user_id!=$owner->user_info.user_id}
          <div class="seBlogSubscribe" {if $is_subscribed} style="display:none;"{/if}><a href="javascript:void(0);" onclick="SupremeEdition.Blog.subscribeBlog(SupremeEdition.Owner.user_info.user_id);">{lang_print id=1500027}</a></div>
          <div class="seBlogUnsubscribe"{if !$is_subscribed} style="display:none;"{/if}><a href="javascript:void(0);" onclick="SupremeEdition.Blog.unsubscribeBlog(SupremeEdition.Owner.user_info.user_id);">{lang_print id=1500028}</a></div>
        {/if}
