{* MEMBER WINKS POPUP *}
 <table id='winks' cellpadding='0' cellspacing='0' class='profile_event_popup2'>
  ...
  <td class='profile_event_popup2'>
    ...
    <tr>
    <td class='profile_event_popup_title'><font color="#000000">{lang_print id=14000055} {$owner->user_info.user_username}?</font></td>
    </tr>
    </table>
      ...
      <td valign='top'><br>
        <div><font color="#000000">{lang_print id=14000056} {$owner->user_info.user_username}. {lang_print id=14000057}</font></div>
        <br><br> 
...
<input type='submit' class='button' value='{lang_print id=14000058}'>
	 ...
	 <br><br>
	   <form action='user_winks_wink.php' method='POST'>
       <input type='submit' class='button' value='{lang_print id=14000059}'>
