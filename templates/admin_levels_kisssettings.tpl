...
<h2>{lang_print id=90000025} {$level_info.level_name}</h2>
{lang_print id=90000026}
...
<td valign='top' class='pagecell' rowspan='{math equation="x+5" x=$level_menu|@count}'>
  ...
  <h2>{lang_print id=90000027}</h2>
  {lang_print id=90000028}

  <br><br>

  {if $result != 0}
  <div class='success'><img src='../images/success.gif' class='icon' border='0'> {lang_print id=90000029}</div>
  {/if}
  ...
  <form action='admin_levels_kisssettings.php' name='info' method='POST'>
  <table cellpadding='0' cellspacing='0' width='600'>
  <tr><td class='header'>{lang_print id=90000030}</td></tr>
  <tr><td class='setting1'>
  {lang_print id=90000031}
  </td></tr><tr><td class='setting2'>
    <table cellpadding='0' cellspacing='0'>
    <tr><td><input type='radio' name='level_kiss_allow' id='kiss_allow_1' value='1'{if $kiss_allow == 1} CHECKED{/if}>&nbsp;</td><td><label for='kiss_allow_1'>{lang_print id=90000032}</label></td></tr>
    <tr><td><input type='radio' name='level_kiss_allow' id='kiss_allow_0' value='0'{if $kiss_allow == 0} CHECKED{/if}>&nbsp;</td><td><label for='kiss_allow_0'>{lang_print id=90000033}</label></td></tr>
	</table>
  </td></tr></table>
  ...
  <table cellpadding='0' cellspacing='0' width='600'>
  <tr><td class='header'>{lang_print id=90000034}</td></tr>
 </tr><tr><td class='setting1'>
  {lang_print id=90000035}
  </td></tr><tr><td class='setting2'>
    <table cellpadding='0' cellspacing='0'>
    {section name=privacy_loop loop=$kiss_privacy}
      <tr><td><input type='checkbox' name='{$kiss_privacy[privacy_loop].privacy_name}' id='{$kiss_privacy[privacy_loop].privacy_name}' value='{$kiss_privacy[privacy_loop].privacy_value}'{if $kiss_privacy[privacy_loop].privacy_selected == 1} CHECKED{/if}></td><td><label for='{$kiss_privacy[privacy_loop].privacy_name}'>{$kiss_privacy[privacy_loop].privacy_option}</label>&nbsp;&nbsp;</td></tr>
    {/section}
    </table>
  </td></tr>
  ...
  <input type='submit' class='button' value='{lang_print id=90000036}'>
