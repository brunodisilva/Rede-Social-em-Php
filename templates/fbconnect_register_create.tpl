...
{*  $Id: fbconnect_register_create.tpl 1 2009-07-04 09:36:11Z SocialEngineAddOns $ * }


{* SHOW STEP TWO (FB Friends Invite Form) *}
{if $step == 6}
	{if !empty($signup_invite_form)}
  	<img src='./images/icons/fbconnect-invite.gif' border='0' class='icon_big'>
  	<div class='page_header'>{lang_print id=729} {lang_print id=650000064}</div>
  	<br />
...
{elseif $step == 2}
  ...
  <form action='fbconnect_register_create.php' method='POST'>
  {* LOOP THROUGH TABS *}
