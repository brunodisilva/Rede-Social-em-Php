...
{* $Id: home.tpl 158 2009-04-09 01:19:50Z john $ *}
...
<div style='float: left; width: 200px;'>
  ...
  {else}
    <div class='portal_login'>
      ...
      <div>[ {include file='fbconnect_header_logout.tpl'} ]</div>
    </div>
    <div class='portal_spacer'></div>
  {/if}
...
<div style='float: left; width: 200px;'>
{* ACTIVITY POINTS 1/1 START *}
  {include file='home_userpoints.tpl'}
  {* ACTIVITY POINTS 1/1 END *}
  {* SHOW LAST SIGNUPS *}
