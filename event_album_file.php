...
/* $Id: event_album_file.php 9 2009-01-11 06:03:21Z john $ */
...
$allowed_to_tag = 1;
if(!($privacy_max & $media_info[eventalbum_tag])) { $allowed_to_tag = 0; }
...
$database->database_query("UPDATE se_eventalbums SET eventalbum_views='$album_views_new' WHERE eventalbum_id='$media_info[eventalbum_id]' LIMIT 1");
