...
/* $Id: installsql.php 164 2009-05-18 20:00:58Z john $ */

$current_database_structure_version = '3.15';
...
(40, 1, 'Reset scriptsocial Admin Password Request', 'admin_lostpass, '),
(41, 1, 'Hello,\r\n\r\nYou have requested to reset your scriptsocial admin password. If you would like to do so, please click the link below. If you did not request a password reset, simply ignore this email.\r\n\r\n[link]\r\n\r\nThank You', 'admin_lostpass, '),
...
(58, 1, 'scriptsocial License:', 'admin_viewusers_edit, admin_viewusers, admin_viewreports, admin_viewplugins, admin_viewadmins, admin_url, admin_templates, admin_subnetworks, admin_stats, admin_signup, admin_profile, admin_log, admin_levels_usersettings, admin_levels_messagesettings, admin_levels_edit, admin_levels_albumsettings, admin_levels, admin_language_edit, admin_language, admin_invite, admin_home, admin_general, admin_faq, admin_emails, admin_connections, admin_banning, admin_announcements, admin_ads_modify, admin_ads, admin_activity, '),
...
(465, 1, 'The system is now set to use subdirectory URLs, which require an .htaccess file in your scriptsocial root directory. Copy and paste the code in the following box into a blank text file named .htaccess, and place it into your scriptsocial root directory. This is the directory on your server in which you have installed scriptsocial.', 'admin_url, '),
...
(1106, 1, 'details', ''),
(1107, 1, 'Any scriptsocial plugins that you have installed will appear on this page. Note that some plugins may have user level-specific settings which are available on the <a href=\'admin_levels.php\'>User Levels</a> page.', 'admin_viewplugins, '),
(1108, 1, 'There are currently no plugins installed. Visit the <a href=\'http://www.sCRiPTz-TEAM.iNFO/\' target=\'_blank\'>scriptsocial website</a> to add plugins to your social network!', 'admin_viewplugins, '),
...
mysql_query("
  ...
  VALUES
    ...
    (1268, 1, 'This is where the temporary files containing the cached data are stored. Folder must be writable (chmod 777). This should be a path relative to the base directory where scriptsocial is installed.', 'admin_cache'),
    ...
    (1286, 1, 'Here you can import a language pack from an exported file. If generated by scriptsocial, the file will contain all of the necessary info to create a new language pack.', 'admin_language_import'),
    ...
    /* admin_session */
    (1299, 1, 'scriptsocial uses sessions to authenticate users and keep them logged-in. The settings below only need to be changed if your users are having trouble logging in (e.g. if your server does not allow native sessions) or if you want to improve system performance by enabling Memcache sessions. If you are not familiar with sessions, we do not recommend that you change any of these settings.', 'admin_session'),
    ...
    (1305, 1, 'If you have enabled file-based sessions above, please provide the path (relative to your scriptsocial base directory) to where you want to store session data. This directory must be writable (chmod 777).', 'admin_session'),
...
mysql_query("CREATE TABLE `se_usersettings` (
  ...
  `usersetting_actions_dontpublish` varchar(150) collate utf8_unicode_ci NOT NULL default '',
  `usersetting_actions_display` varchar(150) collate utf8_unicode_ci NOT NULL default '',
