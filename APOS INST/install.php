...
/* $Id: install.php 163 2009-05-02 01:35:10Z john $ */
...
<html>
<head>
<title>Install scriptsocial</title>
<style type='text/css'>
body
{
...
if($task == "step0")
{
  ...
  echo "
  <h2>Install scriptsocial</h2>
  Welcome to the scriptsocial installation program. Installing scriptsocial is easy! To get started, click the button below. If you have questions about the installation process or scriptsocial in general, get in touch with us at scriptsocial.net.
  <br><br>
  <div class='box2'>
  <b>If you are installing scriptsocial yourself:</b>
  <br>
  ...
  <br>
  <div class='box2'>
  <b>To install scriptsocial you will need:</b>
  <br>
  <ul>
      ...
      <table cellpadding='0' cellspacing='0'>
        <tr>
          <td style='padding: 5px; background: #FFEFEF; color: #AB0000;'>
            ...
            You can refer to the install.html provided with scriptsocial, the FAQ
            scriptsocial.net/faq.php on our site, or our technical support.
  ...
  <td style='padding: 20px; border: 1px solid #CCCCCC; background: #F1F1F1;'>
    ...
    <b>Enter License Key:</b>[[SocialTR.Com Forumlarindan Keygen Alabilirsiniz /TURKOY/]<br>
    ...
    <div style='margin-bottom:10px;'>
      With your permission, we would like to collect some information about your server to help us improve scriptsocial
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          <b><font color='#ff0000' size='3'><label>No, do not allow information to be reported.</label></font></b>
        </td>
      </tr>
    </table>
  ...
  <br>
  <input type='submit' class='button' value='Continue...' "; if( $test_critical ) echo " disabled"; echo " />
...
if($task == "connect")
{
  ...
  {
    $success = 0;
    $result = "<br><br><font color='#FF0000'><b>Database config already exists</b></font><br>You may have already installed scriptsocial. Click \"Force\" below to continue anyway. Your old database_config.php will be overwritten. <br><br><form action='install.php' method='post'><input type='submit' class='button' value='Force...'><input type='hidden' name='task' value='step2'><input type='hidden' name='license' value='$license'></form>";
  }
  else
  {
    $success = 1;
  ...
  if($success == 1)
  {
    ...
    {
      $success = 0;
      $result = "<br><font color='#FF0000'><b>Failed to Create database_config.php</b></font><br>Please be sure the \"include\" directory is set to CHMOD 777 and that you have uploaded install.php and installsql.php to your scriptsocial root directory (NOT in the \"install/\" directory).";
    }
  }
...
if($task == "step2")
{
  ...
  Now that your database is ready, we need to fill it with the appropriate tables and default data. Click the button below to complete your scriptsocial installation.
  <br />
  <br />
  <form action='install.php' method='post'>
...
if($task == "step3")
{
  ...
  You have successfully completed the scriptsocial installation process. You can now login to your control panel with the information shown below. After logging in, you can begin changing the system settings to suit your needs.
  <br><br>
