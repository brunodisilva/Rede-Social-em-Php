...
foreach ($p_friends as $friend){
	...
	<div style='clear:both; margin-bottom:10px'>
					...
					<a href='".htmlentities($url->url_create('profile',$friend->user_info['user_username']))."'>
						<img src='".$friend->user_photo('./images/nophoto.gif', true)."' width='60' height='60' border='0' />
					</a>
					</div>
					<div>
					<a href='".$url->url_create('profile',$friend->user_info['user_username'])."' title='".$friend->user_info['user_username']."'><b>".truncate($friend->user_displayname, 20)."</b></a><br/>
