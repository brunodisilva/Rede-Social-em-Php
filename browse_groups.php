...
/* $Id: browse_groups.php 42 2009-01-29 04:55:14Z john $ */
...
{
  // SET WHERE CLAUSE
  $where .= " AND (SELECT TRUE FROM se_friends LEFT JOIN se_groupmembers ON se_friends.friend_user_id2=se_groupmembers.groupmember_user_id WHERE friend_user_id1='{$user->user_info['user_id']}' AND friend_status=1 AND groupmember_group_id=se_groups.group_id AND groupmember_status=1)";
}
