...
/* $Id: event.php 22 2009-01-16 05:50:49Z john $ */
...
// ########### CALENDAR ###########
/*
$event_day_start = mktime(0, 0, 0, date("m", $event->event_info['event_date_start']), date("j", $event->event_info['event_date_start']),  date("Y", $event->event_info['event_date_start']));
if( $event->event_info['event_date_end'] )
  $event_day_end   = mktime(0, 0, 0, date("m", $event->event_info['event_date_end']),   date("j", $event->event_info['event_date_end']),    date("Y", $event->event_info['event_date_end'])  );
else
