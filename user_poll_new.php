...
/* $Id: user_poll_new.php 12 2009-01-11 06:04:12Z john $ */
...
if( !$user->level_info['level_poll_allow'] )
{
...
{
  // HTML SUPPORT
  $poll_title = cleanHTML(htmlspecialchars_decode($poll_title), $setting['setting_poll_html']);
  $poll_desc = cleanHTML(htmlspecialchars_decode($poll_desc), $setting['setting_poll_html']);
  ...
  {
    $poll_options[$poll_option_index] = cleanHTML(htmlspecialchars_decode($poll_option_label), $setting['setting_poll_html']);
  }
