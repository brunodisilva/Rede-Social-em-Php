<?
$page = "user_kiss_confirm_incoming";
include "header.php";
...
//kiss BACK 
 if($task == "kiss_back") {  
	...
	$kiss_date = time();
	$user_kiss->kiss_back($user->user_info[user_id],$owner->user_info[user_id],$kiss_date);
...
$owner_kiss->kiss_remove_incoming($owner->user_info[user_id],$user->user_info[user_id]); 
   header("Location: user_kiss_incoming.php"); exit();
 }
