 ...
 * @version    $Id: class_radcodes.php 2008-09-21 23:45:12 $
 */

define('RADCODES_LIBRARY_VERSION', 3.03);
//session_start();
...
class rc_validator
{
  ...
  function license($value, $type, $key=null)
  {
  	...
  	$response = file_get_contents("http://www.radcodes.com/gateway/license.php?key=$value&domain=$http_host&type=$type");
