...
var InstantMessengerCore = new Class({
  ...
  userStatusIcon: function( userStatus )
  {
    ...
    {
      default:
      case this.constants.USER_STATUS.OFFLINE: userStatusIcon += 'user_offline16.png';  break;
      case this.constants.USER_STATUS.ONLINE:  userStatusIcon += 'user_online16.png';   break;
      case this.constants.USER_STATUS.AWAY:    userStatusIcon += 'user_away16.png';     break;
      case this.constants.USER_STATUS.BUSY:    userStatusIcon += 'user_away16.png';     break;
    }
