...
$owner_wink = new se_winks();
 ...
 if($task == "wink_back") {  
	...
	$user_wink->wink_back($user->user_info[user_id],$owner->user_info[user_id]);
   ...
   // SEND WINK EMAIL
	...
	// INSERT ACTION  
	$actions->actions_add($user, "sendwink", Array('[wink_owner]', '[wink_sender]'), Array($owner->user_info[user_username], $user->user_info[user_username]));    
