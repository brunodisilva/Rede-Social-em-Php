...
/* $Id: group_discussion_view.php 55 2009-02-10 03:50:30Z john $ */
...
if($task == "post_edit")
{
  ...
  if( $database->database_num_rows($post_query) )
  {
    ...
    {
      $database->database_query("UPDATE se_groupposts SET grouppost_body='{$grouppost_body}' WHERE grouppost_id='{$grouppost_id}' LIMIT 1");
