...
<div class="oz_header">
  <table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr>
      <td align="left"><span id="oz_header_label">{{MANUAL_TITLE}}</span></td>
    ...
    <p>{{MANUAL_INSTRUCTIONS}}</p>
        <table id="oz_manual_emails">
            ...
            <tr>
	            ...
	            <td><input type="text" name="oz_from_name" value="<?php echo ozi_get_config('from_name','') ?>" size="24" class="oz_field_input" /></td>
            </tr>
		    <?php } ?>
		    <?php if (ozi_get_config('your_email',TRUE)) { ?>
            <tr>
		    	<td align="right"><span class="oz_field_label">{{YOUR_EMAIL}}</span></td>
	            <td><input type="text" name="oz_from_email" value="<?php echo ozi_get_config('from_email','') ?>" size="24" class="oz_field_input" onchange="ozCheckEmailField(this)"/> *</td>
            </tr>
		    <?php } ?>
    	    <?php 
			/*
			$subject = isset($_REQUEST['oz_subject']) ? htmlentities($_REQUEST['oz_subject']) :'';
			$text_body = isset($_REQUEST['oz_body']) ? htmlentities($_REQUEST['oz_body']) :'';
        	...
        	<tr><td valign="top" width="150" align="right"><span class="oz_field_label">{{SUBJECT}}</span></td><td><input type="text" name="oz_from_email" value="<?php echo htmlentities($subject) ?>" size="50" class="oz_field_input"/></td></tr>
        	<tr><td valign="top" width="150" align="right"><span class="oz_field_label">{{MESSAGE}}</span></td><td><textarea name="oz_message" class="oz_field_input" cols="50" style="height: 8em"><?php echo htmlentities($text_body) ?></textarea></td></tr>
	        <?php }
			*/
			?>
    	    <?php if (ozi_get_config('allow_personal_message',TRUE)) { ?>
        	<tr><td valign="top" width="150" align="right"><span class="oz_field_label">{{PERSONAL_MESSAGE}}</span></td><td><textarea name="oz_message" class="oz_field_input" cols="50" style="height: 4em"><?php echo htmlentities(ozi_get_param('oz_message',''),ENT_COMPAT,'UTF-8') ?></textarea></td></tr>
	        <?php }?>
           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
