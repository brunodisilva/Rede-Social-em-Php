<?
$page = "admin_userpoints_usertransactions";
...
if($task == "confirm") {
  ...
  semods::redirect("admin_userpoints_usertransactions.php?user_id=$user_id&s=$s&p=$p&f_title=$f_title&f_state=$f_state");
}
...
if($task == "cancel") {
  ...
  semods::redirect("admin_userpoints_usertransactions.php?user_id=$user_id&s=$s&p=$p&f_user=$f_user&f_title=$f_title&f_state=$f_state");
}
