<?
$page = "admin_levels_commentedsettings";
...
// SAVE CHANGES
if($task == "dosave") {
  $level_commented_allow = $_POST['level_commented_allow'] ? 1 : 0;

  // IF THERE WERE NO ERRORS, SAVE CHANGES
  if($is_error == 0) {
    $database->database_query("UPDATE se_levels SET level_commented_allow='$level_commented_allow' WHERE level_id='$level_info[level_id]'");
...
$smarty->assign('commented_allow', $level_info[level_commented_allow]);
