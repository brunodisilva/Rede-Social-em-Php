<?
$page = "admin_levels_gmapsettings";
...
// SAVE CHANGES
if($task == "dosave") {
  $level_gmap_allow = $_POST['level_gmap_allow'] ? 1 : 0;

  // IF THERE WERE NO ERRORS, SAVE CHANGES
  if($is_error == 0) {
    $database->database_query("UPDATE se_levels SET level_gmap_allow='$level_gmap_allow' WHERE level_id='$level_info[level_id]'");
...
$smarty->assign('gmap_allow', $level_info[level_gmap_allow]);
