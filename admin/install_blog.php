...
/* $Id: install_blog.php 53 2009-02-06 04:55:08Z john $ */
  ...
  if( !$database->database_num_rows($resource) )
  {
    $sql = "
      ...
      VALUES 
        ...
        (1500155, 1, '<a href=\"profile.php?user=%1\$s\">%2\$s</a> posted a comment on <a href=\"profile.php?user=%3\$s\">%4\$s</a>\'s <a href=\"blog_entry.php?user=%3\$s&blogentry_id=%6\$s\">blog entry</a>:<div class=\"recentaction_div\">%5\$s</div>', 'actiontypes'),
