<?php
/* $Id: admin_fbconnect_users.php 1 2009-07-04 09:36:11Z SocialEngineAddOns $ */
$page = "admin_fbconnect_users";
...
$user_query = "SELECT user_id, user_username, user_fname, user_lname, user_email, user_enabled, user_verified, user_signupdate, user_level_id, user_subnet_id FROM se_users INNER JOIN fbconnect_users ON se_users.user_id =  fbconnect_users.uid";
